  ...
  return (
    <div className='bg-blue flex justify-center items-center flex-col py-7'>
        ...
        <div  className='flex justify-center items-center flex-col gap-4 '>
              ...
              <p className='w-[70%] text-center text-white'>Explore the latest gadgets that will take your experience to the next level. From smart devices to the coolest accessories, we have it all!</p>
